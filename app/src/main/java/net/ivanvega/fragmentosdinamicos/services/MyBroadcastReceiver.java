package net.ivanvega.fragmentosdinamicos.services;
...
import net.ivanvega.fragmentosdinamicos.DetalleFragment;
import net.ivanvega.fragmentosdinamicos.MainActivity;
